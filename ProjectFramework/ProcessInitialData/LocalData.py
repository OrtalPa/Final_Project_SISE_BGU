...
PATH = r'C:\Users\ortal\Documents\FinalProject\data\NewData\SplitV2'
...
for file_path in glob.glob(f"{PATH}\\politics_responses\\*.csv"):
    try:
        ...
        df.to_csv(f'{PATH}\\ProcessedData\\politics_responses\\{file_name}.csv')
